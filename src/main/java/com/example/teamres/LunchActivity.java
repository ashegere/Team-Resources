    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(LunchActivity.this);
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dbh.insertFood(food,2);
                        foodList = dbh.getAllFoods(2);
                        adapter.setFoods(foodList);

                        Toast.makeText(LunchActivity.this, "Food Saved", Toast.LENGTH_SHORT).show();
                        foodItem.setText("");
                        dialog.cancel();
