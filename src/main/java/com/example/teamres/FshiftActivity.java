...
public class FshiftActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fshift);
        ...
        fRecyclerView = findViewById(R.id.fShiftRv);
        ...
        assnList = dbh.getAllAssignments(1);
        fRecyclerView.setAdapter(adapter);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(FshiftActivity.this);
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dbh.insertAssignment(assn,1);
                        assnList = dbh.getAllAssignments(1);
                        adapter.setAssn(assnList);

                        Toast.makeText(FshiftActivity.this, "Message Saved", Toast.LENGTH_SHORT).show();
                        foodItem.setText("");
                        dialog.cancel();
        ...
        clearbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                for(int i = 0; i < assnList.size();i++) {
                    ...
                    as.setDate(null);
                    as.setStatus(0);
                    dbh.updateStatus(as, as.getId(), 1);
                    dbh.updateDate(as, as.getId(), 1);
                }
