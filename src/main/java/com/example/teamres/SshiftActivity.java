...
public class SshiftActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sshift);
        ...
        assnList = dbh.getAllAssignments(2);
        fRecyclerView.setAdapter(adapter);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(SshiftActivity.this);
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dbh.insertAssignment(assn,2);
                        assnList = dbh.getAllAssignments(2);
                        adapter.setAssn(assnList);

                        Toast.makeText(SshiftActivity.this, "Message Saved", Toast.LENGTH_SHORT).show();
                        newTask.setText("");
                        dialog.cancel();
        ...
        clearbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                for(int i = 0; i < assnList.size();i++) {
                    ...
                    as.setDate(null);
                    as.setStatus(0);
                    dbh.updateStatus(as, as.getId(), 2);
                    dbh.updateDate(as, as.getId(), 2);
                }
