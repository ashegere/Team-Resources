    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(DinnerActivity.this);
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dbh.insertFood(food,3);
                        foodList = dbh.getAllFoods(3);
                        adapter.setFoods(foodList);

                        Toast.makeText(DinnerActivity.this, "Food Saved", Toast.LENGTH_SHORT).show();
                        foodItem.setText("");
                        dialog.cancel();
